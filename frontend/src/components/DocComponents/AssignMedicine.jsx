...
export default function AssignMedicine(props) {
    ...
    useEffect(() => {
        ...
        axios.get(process.env.NODE_ENV==='production' ?"medInfo" :"http://localhost:3005/medInfo")
            .then(response => {
    ...
    async function saveMedInfo() {
        ...
        await axios.post(process.env.NODE_ENV==='production' ?"saveMedInfo" :'http://localhost:3005/saveMedInfo', {
            patients: PIDs,
            medicines: MIDs,
        })
            .then(response => {
