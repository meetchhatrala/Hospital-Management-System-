...
export default function DoctorMenu() {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            await axios.get(process.env.NODE_ENV==='production' ?"patients" :'http://localhost:3005/patients', {
            ...
            await axios.get(process.env.NODE_ENV==='production' ?"wardInfo" :'http://localhost:3005/wardInfo')
                .then((response) => {
                    console.log(response.data);
